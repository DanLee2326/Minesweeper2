...
void Scores::addScore(int newScore, int boardType)
{
	this->score = newScore;
	switch (boardType) {
...
void Scores::read(int boardType)
{
	char read[100];
	switch (boardType)
	{
...
void Scores::writeFile(int boardType)
{
	switch (boardType)
	{
	case 1:
...
vector<int> Scores::getScores9() const
{
	return this->List9;
}
vector<int> Scores::getScores16() const
{
	return this->List16;
}
vector<int> Scores::getScores24() const
{
	return this->List24;
}
